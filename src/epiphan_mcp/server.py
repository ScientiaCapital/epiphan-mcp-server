...
from .tools.fleet import (
    batch_start_recording as _batch_start_recording,
    batch_stop_recording as _batch_stop_recording,
    fleet_health_report as _fleet_health_report,
    generate_shift_handoff as _generate_shift_handoff,
    get_fleet_status as _get_fleet_status,
...
async def get_fleet_status() -> dict[str, Any]:
    ...
    """
    return await _get_fleet_status()
...
async def batch_start_recording(device_ids: str = "all") -> dict[str, Any]:
    ...
    """
    return await _batch_start_recording(device_ids=device_ids)
...
async def batch_stop_recording(device_ids: str = "all") -> dict[str, Any]:
    ...
    Returns:
        Results for each device.
    """
    return await _batch_stop_recording(device_ids=device_ids)
...
async def fleet_health_report() -> dict[str, Any]:
    ...
    """
    return await _fleet_health_report()
